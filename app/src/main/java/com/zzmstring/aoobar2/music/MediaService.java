package com.zzmstring.aoobar2.music;
...
import com.zzmstring.aoobar2.MainActivity;
import com.zzmstring.aoobar2.bean.MusicInfo;
...
public class MediaService extends Service {
    ...
    private int page = 1;// 列表页面(默认全部歌曲)
